...
def draw_results(image, model_results):
        ...
        for obj in model_results:
            ...
            cv.putText(img_cpy, "{:.2f}".format(confi), (x0+110, y0 + txt_size[1]), font, font_scale, txt_color_dark, thickness=thickness+1)
            cv.putText(img_cpy, "{:.2f}".format(confi), (x0+110, y0 + txt_size[1]), font, font_scale, txt_color_light, thickness=thickness)
